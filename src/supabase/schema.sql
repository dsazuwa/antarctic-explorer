...
ALTER TABLE IF EXISTS antarctic.expeditions DROP CONSTRAINT IF EXISTS uc_cruise_line_name;
...
CREATE TABLE antarctic.expeditions (
  ...
  CONSTRAINT uc_cruise_line_name UNIQUE (cruise_line_id, name)
);
