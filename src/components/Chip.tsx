...
function Chip({ label, handleClick }: ChipProps) {
  return (
    <div className='my-1 mr-1.5 inline-flex items-center rounded-2xl border border-solid border-primary/50 px-4 py-2 text-xxs font-bold text-primary/75 hover:shadow'>
      {label}
      <button
